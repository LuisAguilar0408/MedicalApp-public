...
namespace SoftWA
{
    ...
    public partial class perfil_paciente : System.Web.UI.Page
    {
        ...
        private void PopulateEditControls(UsuarioPerfilInfo perfil)
        {
            ...
            // Para TextMode="Date", el formato debe ser yyyy-MM-dd
        ...
        protected void btnSaveChanges_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (exito_simulado)
                {
                    ...
                    PopulateViewControls(perfilActualizado); // Actualizar la vista con los nuevos datos
                    SwitchMode(false); // Volver al modo vista
                }
                else
                {
